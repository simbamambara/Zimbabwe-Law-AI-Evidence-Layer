...
| Duplicate handling | `data/metadata/duplicate_source_occurrences.csv` |
| Privacy impact | `docs/governance/02_PRIVACY_IMPACT_ASSESSMENT.md` |
| Processing records | `docs/governance/03_RECORD_OF_PROCESSING_ACTIVITIES.md`, processing register |
| Governance | `docs/governance/01_DATA_GOVERNANCE_POLICY.md` |
| Access and security | Access policy, incident procedure, secure-development policy, access register |
| Retention | Retention policy and schedule |
| Human review | Human-review policy, manual-review queue, approval register |
| Data-subject rights | Rights procedure and request register |
| Correction and takedown | Correction procedure and register |
| Third parties and transfers | Processor policy and register; transfer assessment |
| AI boundaries | AI assessment, system card, deployment boundaries |
| Risk | `docs/registers/risk_register.csv` |
